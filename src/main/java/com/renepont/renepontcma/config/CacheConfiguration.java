package com.renepont.renepontcma.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.renepont.renepontcma.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.renepont.renepontcma.repository.UserRepository.USERS_BY_EMAIL_CACHE);
