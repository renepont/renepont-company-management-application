...
import static com.renepont.renepontcma.domain.CustomerAsserts.*;
...
class CustomerResourceIT {
    ...
    private static final Boolean DEFAULT_VAT_REQUIRED = false;
    private static final Boolean UPDATED_VAT_REQUIRED = true;
    ...
    public static Customer createEntity() {
        return new Customer().name(DEFAULT_NAME).vatRequired(DEFAULT_VAT_REQUIRED);
    }
    ...
    public static Customer createUpdatedEntity() {
        return new Customer().name(UPDATED_NAME).vatRequired(UPDATED_VAT_REQUIRED);
    }
    ...
    @Test
    @Transactional
    void checkVatRequiredIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        customer.setVatRequired(null);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].vatRequired").value(hasItem(DEFAULT_VAT_REQUIRED)));
    }
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.vatRequired").value(DEFAULT_VAT_REQUIRED));
    }
    ...
    @Test
    @Transactional
    void getAllCustomersByVatRequiredIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCustomer = customerRepository.saveAndFlush(customer);

        // Get all the customerList where vatRequired equals to
        defaultCustomerFiltering("vatRequired.equals=" + DEFAULT_VAT_REQUIRED, "vatRequired.equals=" + UPDATED_VAT_REQUIRED);
    }

    @Test
    @Transactional
    void getAllCustomersByVatRequiredIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCustomer = customerRepository.saveAndFlush(customer);

        // Get all the customerList where vatRequired in
        defaultCustomerFiltering(
            "vatRequired.in=" + DEFAULT_VAT_REQUIRED + "," + UPDATED_VAT_REQUIRED,
            "vatRequired.in=" + UPDATED_VAT_REQUIRED
        );
    }

    @Test
    @Transactional
    void getAllCustomersByVatRequiredIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCustomer = customerRepository.saveAndFlush(customer);

        // Get all the customerList where vatRequired is not null
        defaultCustomerFiltering("vatRequired.specified=true", "vatRequired.specified=false");
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).vatRequired(UPDATED_VAT_REQUIRED);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).vatRequired(UPDATED_VAT_REQUIRED);
