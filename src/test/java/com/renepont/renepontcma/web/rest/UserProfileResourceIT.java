...
import static com.renepont.renepontcma.domain.UserProfileAsserts.*;
...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity() {
        return new UserProfile().phoneNumber(DEFAULT_PHONE_NUMBER).jobTitle(DEFAULT_JOB_TITLE);
    }
    ...
    public static UserProfile createUpdatedEntity() {
        return new UserProfile().phoneNumber(UPDATED_PHONE_NUMBER).jobTitle(UPDATED_JOB_TITLE);
    }
    ...
    @Test
    @Transactional
    void getAllUserProfilesByJobTitleIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedUserProfile = userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where jobTitle equals to
        defaultUserProfileFiltering("jobTitle.equals=" + DEFAULT_JOB_TITLE, "jobTitle.equals=" + UPDATED_JOB_TITLE);
    }

    @Test
    @Transactional
    void getAllUserProfilesByJobTitleIsInShouldWork() throws Exception {
        // Initialize the database
        insertedUserProfile = userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where jobTitle in
        defaultUserProfileFiltering("jobTitle.in=" + DEFAULT_JOB_TITLE + "," + UPDATED_JOB_TITLE, "jobTitle.in=" + UPDATED_JOB_TITLE);
    }

    @Test
    @Transactional
    void getAllUserProfilesByJobTitleIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedUserProfile = userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where jobTitle is not null
        defaultUserProfileFiltering("jobTitle.specified=true", "jobTitle.specified=false");
    }

    @Test
    @Transactional
    void getAllUserProfilesByJobTitleContainsSomething() throws Exception {
        // Initialize the database
        insertedUserProfile = userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where jobTitle contains
        defaultUserProfileFiltering("jobTitle.contains=" + DEFAULT_JOB_TITLE, "jobTitle.contains=" + UPDATED_JOB_TITLE);
    }

    @Test
    @Transactional
    void getAllUserProfilesByJobTitleNotContainsSomething() throws Exception {
        // Initialize the database
        insertedUserProfile = userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where jobTitle does not contain
        defaultUserProfileFiltering("jobTitle.doesNotContain=" + UPDATED_JOB_TITLE, "jobTitle.doesNotContain=" + DEFAULT_JOB_TITLE);
    }
    ...
    @Test
    @Transactional
    void getAllUserProfilesByCompanyIsEqualToSomething() throws Exception {
        Company company;
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.phoneNumber(UPDATED_PHONE_NUMBER).jobTitle(UPDATED_JOB_TITLE);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.phoneNumber(UPDATED_PHONE_NUMBER).jobTitle(UPDATED_JOB_TITLE);
